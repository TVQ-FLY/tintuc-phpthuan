<?php 
   ...
   if($query):
    ...
    echo "<script>alert('Lỗi rồi thử lại đi');</script>";  
               ...
               <div class="card border-0">
                  <div class="card-body">
                    <a class="badge bg-success text-decoration-none link-light" href="category.php?catid=<?php echo htmlentities($row['cid'])?>" style="color:#fff"><?php echo htmlentities($row['category']);?></a>
                     ...
                     <p>
                         Người đăng:  <?php echo htmlentities($row['postedBy']);?> | <?php echo htmlentities($row['postingdate']);?>
                        <?php if($row['lastUpdatedBy']!=''):?> |
                           Cập nhật lần cuối bởi <?php echo htmlentities($row['lastUpdatedBy']);?> vào <?php echo htmlentities($row['UpdationDate']);?>
                     </p>
                     <?php endif;?>
               ...
               <div class="media mb-4">
                  ...
                  <div class="media-body">
                     <h5 class="mt-0"><?php echo htmlentities($row['name']);?> <br />
                        <span style="font-size:11px;"><b>Thời gian</b> <?php echo htmlentities($row['postingDate']);?></span>
                     </h5>
                  ...
                  <div class="card-body">
                     <form name="Comment" method="post">
                        ...
                        <div class="form-group">
                           <input type="text" name="name" class="form-control rounded-0" placeholder="Nhập tên" required>
                        </div>
                        <div class="form-group">
                           <input type="email" name="email" class="form-control rounded-0" placeholder="Nhập địa chỉ email" required>
                        </div>
                        <div class="form-group">
                           <textarea class="form-control rounded-0" name="comment" rows="3" placeholder="Nội dung bình luận" required></textarea>
                        </div>
