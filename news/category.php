...
<h1><?php echo htmlentities($row['category']);?> News</h1>
       ...
       <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
            <div class="card-body">
                  <p class="text-right mb-0"><small>Thời gian <?php echo htmlentities($row['postingdate']);?></small></p>
              ...
              <a href="news-details.php?nid=<?php echo htmlentities($row['pid'])?>" class="">Chi tiết &rarr;</a>
            </div>
...
<?php } ?>
    ...
    <ul class="pagination justify-content-center mb-4">
        ...
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?> page-item">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>" class="page-link">Trước đó</a>
        </li>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?> page-item">
            <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?> " class="page-link">Kế tiếp</a>
        </li>
